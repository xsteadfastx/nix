...
let
  sharedHooks = {
    ...
    postswitch."move-workspaces" = ''
      ...
      export XAUTHORITY=/home/marv/.Xauthority
      export I3SOCK=$(${pkgs.i3}/bin/i3 --get-socketpath)
      MIDDLE=$(${pkgs.xorg.xrandr}/bin/xrandr --query | grep " connected" | ${pkgs.gawk}/bin/awk '{print $1}' | grep -v "eDP-1\|DP-1$\|DP-2$\|DP-1-3$" | grep -E "DP-2-2|DP-2-1|DP-1-1" | head -1)
      RIGHT=$(${pkgs.xorg.xrandr}/bin/xrandr --query | grep " connected" | ${pkgs.gawk}/bin/awk '{print $1}' | grep -E "^DP-1$|^DP-2$|^DP-1-3$" | head -1)
  ...
  services.autorandr = {
    ...
    profiles = {
      ...
      "home" = {
        ...
        fingerprint = {
          eDP-1 = eDP1.fingerprint;
          DP-1-3 = "";
          DP-1-1 = "";
        };
        config = {
          eDP-1 = lib.mkMerge [
            eDP1.config
